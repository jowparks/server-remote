...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_rust_lib_rustbuffer_alloc(size, status)
        }.also {
            if(it.data == null) {
...
internal interface UniffiLib : Library {
    ...
    fun uniffi_rust_lib_fn_clone_session(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    ...
    fun ffi_rust_lib_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun ffi_rust_lib_rust_future_poll_u8(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_u8(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_u8(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_u8(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Byte
    fun ffi_rust_lib_rust_future_poll_i8(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_i8(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_i8(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_i8(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Byte
    fun ffi_rust_lib_rust_future_poll_u16(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_u16(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_u16(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_u16(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Short
    fun ffi_rust_lib_rust_future_poll_i16(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_i16(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_i16(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_i16(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Short
    fun ffi_rust_lib_rust_future_poll_u32(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_u32(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_u32(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_u32(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    fun ffi_rust_lib_rust_future_poll_i32(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_i32(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_i32(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_i32(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    fun ffi_rust_lib_rust_future_poll_u64(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_u64(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_u64(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_u64(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    fun ffi_rust_lib_rust_future_poll_i64(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_i64(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_i64(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_i64(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    fun ffi_rust_lib_rust_future_poll_f32(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_f32(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_f32(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_f32(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Float
    fun ffi_rust_lib_rust_future_poll_f64(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_f64(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_f64(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_f64(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Double
    fun ffi_rust_lib_rust_future_poll_pointer(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_pointer(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_pointer(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_pointer(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun ffi_rust_lib_rust_future_poll_rust_buffer(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_rust_buffer(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_rust_buffer(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_rust_buffer(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun ffi_rust_lib_rust_future_poll_void(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_rust_lib_rust_future_cancel_void(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_free_void(`handle`: Pointer,
    ): Unit
    fun ffi_rust_lib_rust_future_complete_void(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
 ...
 * that handles the input/output event loop
 */
open class Session : FFIObject, SessionInterface {
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_rust_lib_fn_free_session(ptr, status)
                }
            }
        }
    }
    ...
    override fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_rust_lib_fn_clone_session(pointer!!, status)
        }
    }
...
public object FfiConverterTypeSession: FfiConverter<Session, Pointer> {
    ...
    override fun allocationSize(value: Session) = 8
...
sealed class EnumException: Exception() {
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<EnumException> {
        override fun lift(error_buf: RustBuffer.ByValue): EnumException = FfiConverterTypeEnumError.lift(error_buf)
    }

    
}

public object FfiConverterTypeEnumError : FfiConverterRustBuffer<EnumException> {
    override fun read(buf: ByteBuffer): EnumException {
    ...
    override fun allocationSize(value: EnumException): Int {
        return when(value) {
    ...
    override fun write(value: EnumException, buf: ByteBuffer) {
        when(value) {
            is EnumException.Oops -> {
                buf.putInt(1)
